          ...
          <div className="lg:col-span-8 flex flex-col gap-4 min-h-0">
                      ...
                      {taskData?.attachments?.map((file, idx) => (
                        ...
                        >
                          <div className="flex items-center gap-2.5 min-w-0">
                            ...
                            <div className="flex flex-col min-w-0">
                              <span className="text-[10px] font-black text-white/80 truncate group-hover:text-white">
                                {file.name}
                              </span>
              ...
              <section className="bg-gradient-to-br from-secondary/10 to-transparent border border-secondary/30 rounded-2xl p-6 shadow-2xl animate-in zoom-in-95 duration-500">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-white/50 font-black uppercase tracking-widest leading-loose">
            ...
            <section className="bg-white/5 border border-white/10 p-2 rounded-xl flex flex-wrap lg:flex-nowrap items-center justify-between gap-4 shrink-0 shadow-xl px-4">
              ...
              <div className="flex items-center gap-3 shrink-0">
                <div
                  className={`w-7 h-7 rounded-lg bg-black border flex items-center justify-center transition-all ${taskData?.status === TASK_STATUS.IN_PROGRESS ? 'border-status-success shadow-[0_0_10px_rgba(16,185,129,0.1)] animate-pulse' : 'border-white/10'}`}
                >
                  <Clock size={10} className="text-status-success" />
                </div>
                <div className="flex flex-col">
                  <span className="block text-[8px] font-black text-white/30 uppercase tracking-[0.3em]">
                    ALLOCATION
                  </span>
              ...
              <div className="flex items-center gap-3 shrink-0 group">
                <div
                  className={`w-7 h-7 rounded-lg bg-black border flex items-center justify-center transition-all ${taskData?.dueDate && new Date(taskData?.dueDate) < new Date() && taskData?.status !== TASK_STATUS.DONE ? 'border-status-error animate-pulse' : 'border-primary/30'}`}
                >
          ...
          <div className="fixed inset-0 z-[200] flex items-center justify-center p-6 bg-black/80 backdrop-blur-xl animate-in fade-in duration-500">
            <div className="bg-black border border-white/30 w-full max-w-sm rounded-[2.5rem] p-10 shadow-3xl animate-in zoom-in-95 duration-500 text-center">
              <div className="flex flex-col items-center">
                ...
                <h2 className="text-2xl font-black text-white tracking-tighter mb-3 uppercase">
                  Update status
                </h2>
                <p className="text-[11px] text-white/50 font-black uppercase tracking-widest leading-loose mb-10 px-6">
                ...
                <div className="grid grid-cols-2 gap-4 w-full">
                  <button
                    ...
                    className="py-4 bg-black text-white/60 rounded-xl text-[11px] font-black uppercase tracking-widest border border-white/30 hover:bg-white/5 hover:text-white transition-all active:scale-95"
                  >
                    Cancel
                  </button>
                  <button
                    ...
                    className={`py-4 rounded-xl font-black text-[11px] text-black uppercase tracking-[0.2em] shadow-2xl transition-all active:scale-95 hover:brightness-110 ${confirmModal.targetStatus?.id === TASK_STATUS.DONE ? 'bg-status-success' : 'bg-primary'}`}
                  >
                    Update
                  </button>
                </div>
          ...
          <div className="fixed inset-0 z-[200] flex items-center justify-center p-6 bg-black animate-in fade-in duration-500">
            <div className="bg-black border border-white w-full max-w-sm rounded-[2.5rem] p-10 shadow-3xl animate-in zoom-in-95 duration-500 text-center">
              <div className="flex flex-col items-center">
                ...
                <p className="text-[10px] text-white font-black uppercase tracking-widest leading-loose mb-6 px-6">
                ...
                <div className="grid grid-cols-2 gap-4 w-full">
                  <button
                    ...
                    className="py-4 bg-black text-white/60 rounded-xl text-[11px] font-black uppercase tracking-[0.2em] border border-white/30 hover:bg-white/5 hover:text-white transition-all active:scale-95"
                  >
                    Cancel
                  </button>
                  <button

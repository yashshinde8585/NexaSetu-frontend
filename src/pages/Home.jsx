...
// The primary public landing page that showcases system features, integrations, and pricing plans.
const Home = () => {
    ...
    <div className="min-h-screen bg-background-dark text-white selection:bg-primary/30 overflow-x-hidden font-sans">
      ...
      <header className="relative z-10 pt-40 pb-32 px-6 max-w-7xl mx-auto text-center">
        ...
        <p className="max-w-3xl mx-auto text-text-muted text-lg md:text-xl font-medium mb-12 animate-in fade-in duration-1000 delay-300 leading-relaxed">
          NexaSetu streamlines project workflows and team collaboration. Manage
          your entire project portfolio with AI-powered task assistance and
          complete security.
        </p>
      ...
      <section id="features" className="py-32 px-6 max-w-7xl mx-auto">
        <div className="text-center mb-20">
          ...
          <p className="text-text-muted max-w-2xl mx-auto text-lg leading-relaxed">
            Everything you need to manage complex projects and teams without the
            friction.
          </p>
        </div>
        ...
        <div className="max-w-5xl mx-auto glass p-8 md:p-12 rounded-[2.5rem] border border-white/10 flex flex-col md:flex-row items-center gap-12">
          <div className="flex-1 space-y-6">
            ...
            <p className="text-text-muted text-lg leading-relaxed">
              Stop clicking through endless menus. Control your entire
              infrastructure through a unified command interface.
            </p>
          ...
          <div className="flex-1 w-full bg-background-dark/80 rounded-2xl border border-white/10 p-6 shadow-2xl shadow-indigo-500/10">
            <div className="flex items-center gap-2 mb-4 border-b border-white/5 pb-4">
              ...
              <span className="text-[10px] text-text-muted font-mono ml-2 uppercase tracking-widest">
                NexaSetu-cli
              </span>
            </div>
            <div className="font-mono text-sm space-y-2">
              ...
              <div className="text-text-muted pl-4">
                Connected to Nexus-Prime [prod-us-east]
              </div>
      ...
      <section id="pricing" className="py-32 px-6 max-w-7xl mx-auto">
        <div className="text-center mb-20">
          <h2 className="text-3xl md:text-5xl font-bold mb-6">
            Simple <span className="text-gradient">Pricing Plans</span>
          </h2>
          <p className="text-text-muted max-w-2xl mx-auto font-medium">
            Choose the best plan for your team's growth and productivity.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-end">
          ...
          <div className="p-10 glass rounded-[2.5rem] border border-white/10 hover:border-white/20 transition-all flex flex-col group h-full">
            <div className="mb-8">
              ...
              <h3 className="text-sm font-bold text-primary uppercase tracking-[0.2em] mb-4">
                Free Plan
              </h3>
            ...
            <ul className="space-y-4 mb-10 flex-1">
              <li className="flex items-center gap-3 text-sm font-medium">
                <CheckCircle size={16} className="text-primary" /> 1 Active
                Workspace
              </li>
              <li className="flex items-center gap-3 text-sm font-medium">
                <CheckCircle size={16} className="text-primary" /> 3 Portfolio
                Projects
              </li>
              <li className="flex items-center gap-3 text-sm font-medium text-text-muted/50">
                <CheckCircle size={16} className="text-white/10" /> AI Insights
                [Limited]
              </li>
            </ul>
            <Link
          ...
          <div className="p-10 bg-linear-to-b from-primary/10 to-transparent glass border border-primary/30 rounded-[2.5rem] shadow-2xl shadow-primary/10 relative overflow-hidden flex flex-col scale-105 z-10 h-[105%] group">
            ...
            <div className="mb-8 font-bold">
              ...
              <h3 className="text-sm font-black text-primary uppercase tracking-[0.2em] mb-4">
                Professional Plan
              </h3>
              <div className="text-5xl font-bold mb-2">
                $49
                <span className="text-lg text-text-muted font-medium">/mo</span>
              </div>
              <p className="text-text-muted text-sm">
            ...
            <ul className="space-y-4 mb-10 flex-1">
              <li className="flex items-center gap-3 text-sm font-bold">
                <CheckCircle size={16} className="text-primary" /> Unlimited
                Projects
              </li>
              <li className="flex items-center gap-3 text-sm font-bold">
                <CheckCircle size={16} className="text-primary" /> Full Magic
                Bar AI
              </li>
              <li className="flex items-center gap-3 text-sm font-bold">
                <CheckCircle size={16} className="text-primary" /> GitHub
                Cluster Sync
              </li>
              <li className="flex items-center gap-3 text-sm font-bold">
                <CheckCircle size={16} className="text-primary" /> Priority API
                Access
              </li>
            </ul>
            <Link
          ...
          <div className="p-10 glass rounded-[2.5rem] border border-white/10 hover:border-white/20 transition-all flex flex-col group h-full">
            <div className="mb-8 font-bold">
              ...
              <h3 className="text-sm font-bold text-primary-light uppercase tracking-[0.2em] mb-4">
                Enterprise Plan
              </h3>
            ...
            <ul className="space-y-4 mb-10 flex-1">
              <li className="flex items-center gap-3 text-sm font-medium">
                <CheckCircle size={16} className="text-primary" /> Multi-Cloud
                Deployments
              </li>
              <li className="flex items-center gap-3 text-sm font-medium">
                <CheckCircle size={16} className="text-primary" /> Custom AI
                Training
              </li>
              <li className="flex items-center gap-3 text-sm font-medium">
                <CheckCircle size={16} className="text-primary" /> 24/7
                Strategic Support
              </li>
            </ul>
            <Link
      ...
      <section className="pb-32 px-6">
        <div className="max-w-6xl mx-auto glass rounded-[3rem] p-12 md:p-20 text-center relative overflow-hidden group border border-white/10 shadow-3xl">
          ...
          <p className="text-text-muted mb-12 max-w-2xl mx-auto relative z-10 text-lg md:text-xl font-medium leading-relaxed">
            Join 500+ fast-moving teams using NexaSetu to maintain complex
            project workflows without the friction.
          </p>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-text-muted max-w-sm text-lg leading-relaxed">
              Building the next generation of project orchestration for
              high-density engineering environments.
            </p>
          </div>
          <div>

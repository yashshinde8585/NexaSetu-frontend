...
// Displays subscription plans and allows users to choose or upgrade their workspace tier.
const Pricing = () => {
  ...
  const plans = [
    ...
    },
    {
      ...
      price: '$29',
      description:
        'Fuel your team with advanced AI insights and collaboration.',
      features: [
        'Unlimited Projects',
        'Team Invitations',
        'Magic Bar Autopilot',
        'Advanced Portfolio Health',
        'GitHub Integration',
      ],
    ...
    },
    {
      ...
      price: 'Custom',
      description:
        'Scale securely with multi-tenant governance and dedicated AI.',
      features: [
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16 animate-in fade-in slide-in-from-bottom-5 duration-700">
          ...
          <p className="text-xl text-text-muted max-w-2xl mx-auto font-light">
            Select a plan to finalize your workspace setup. You can upgrade or
            change your hub's capacity at any time.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {plans.map((plan, idx) => (
            ...
            >
              ...
              <div className="mb-8">
                <h3 className="text-xl font-bold text-text mb-2 tracking-wide uppercase">
                  {plan.name}
                </h3>
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-12 text-center text-white/40">
          <div className="flex flex-col items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs font-light">
                Multi-tenant kernel ensures your data is strictly siloed from
                other users.
              </p>
            </div>
          </div>
          <div className="flex flex-col items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs font-light">
                Select a plan and your workspace is live within 300ms.
              </p>
            </div>
          </div>
          <div className="flex flex-col items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs font-light">
                Admin tools to manage your team and projects across the entire
                portfolio.
              </p>
            </div>
          </div>

        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start relative z-10">
            ...
            <div className="bg-white/5 border border-white/10 p-5 sm:p-6 rounded-xl relative overflow-hidden group hover:border-white/20 transition-colors">
              {submitError && (
                <div className="mb-6 sm:mb-8 p-4 sm:p-6 bg-status-error/5 border border-status-error/30 rounded-xl flex items-start gap-3 sm:gap-4 animate-in slide-in-from-top-4">
                  ...
                  <p className="text-[10px] text-white/70 font-black uppercase tracking-widest leading-relaxed">
                    {submitError}
                  </p>
                </div>
              )}
                ...
                <div className="space-y-6 sm:space-y-8">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <label className="text-[9px] font-black text-white/30 uppercase tracking-[0.2em]">
                        PROJECT NAME
                      </label>
                      <input
          ...
          <div className="hidden lg:block lg:col-span-5 xl:col-span-4 sticky top-24 order-1 lg:order-2">
            <div className="space-y-4">
              <h2 className="text-[9px] font-black text-white/30 uppercase tracking-[0.2em] px-2">
                PROJECT PREVIEW
              </h2>
                ...
                <div className="p-6 space-y-6 relative z-10">
                  ...
                  <div className="flex justify-between items-start">
                    <div className="px-2.5 py-1 bg-white/5 rounded border border-white/10">
                      <p className="text-[8px] font-black tracking-[0.2em] uppercase text-white/30">
                        STATUS: PENDING
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 pt-4 border-t border-white/10">
                    <div className="space-y-1">
                      <p className="text-[8px] font-black text-white/20 uppercase tracking-[0.1em]">
                        TYPE
                      </p>

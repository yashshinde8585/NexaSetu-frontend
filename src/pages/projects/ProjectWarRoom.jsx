...
const ProjectWarRoom = () => {
  ...
  const {
    ...
    queryFn: () =>
      apiClient
        .get(`/leadership/war-room/${projectId}`)
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-3 mb-0.5">
              ...
              <span
                className={`text-[8px] font-bold px-1.5 py-0.5 rounded border uppercase tracking-widest ${getHealthColor(project.health)}`}
              >
            ...
            <div className="space-y-3">
              {directives.length > 0 ? (
                directives.map((d, i) => (
                  <div
                    key={i}
                    className="flex items-center justify-between p-3 bg-primary/5 border border-primary/10 rounded-lg group hover:border-primary/30 transition-all"
                  >
                    <div className="flex items-center gap-3">
              ...
              {burnoutRisks.length > 0 ? (
                burnoutRisks.map((m, i) => (
                  ...
                  >
                    ...
                    <div className="text-right">
                      <span className="block text-[10px] font-black text-status-warning">
                        {m.load}%
                      </span>
                      <span className="text-[7px] font-black text-status-error uppercase">
                        Overload
                      </span>
                    </div>
                  </div>

...
const SprintList = React.lazy(
  () => import('../../components/dashboard/SprintList')
);
const RoleAnalytics = React.lazy(
  () => import('../../components/dashboard/RoleAnalytics')
);
const ApprovalPanel = React.lazy(
  () => import('../../components/portfolio/ApprovalPanel')
);
const ProjectOverviewList = React.lazy(
  () => import('../../components/dashboard/ProjectOverviewList')
);
const ProjectHealthSummary = React.lazy(
  () => import('../../components/dashboard/ProjectHealthSummary')
);

import { resolveDashboard } from './DashboardRegistry';
...
const Dashboard = () => {
  ...
  return (
    <ResilientPage error={error} onRetry={() => window.location.reload()}>
      {TacticalDashboard ? (
        ...
        <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 pb-10 space-y-8">
          ...
          <div className="space-y-8">
            ...
            <div className="relative z-20">
              <React.Suspense
                fallback={
                  <div className="h-80 bg-white/[0.02] border border-white/5 rounded-2xl animate-pulse" />
                }
              >
                <RoleAnalytics
                  user={user}
            ...
            <div className="pt-6 transition-all duration-1000">
              <React.Suspense
                fallback={
                  <div className="h-40 bg-white/[0.02] border border-white/5 rounded-2xl animate-pulse" />
                }
              >
                <ApprovalPanel

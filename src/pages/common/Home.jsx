...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-white font-sans selection:bg-white selection:text-black antialiased overflow-x-hidden nexa-grid">
      ...
      >
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
          <div className="max-w-2xl">
            <h2 className="text-4xl md:text-6xl font-bold tracking-tighter uppercase mt-4">
              Engine Capabilities
            </h2>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 bg-white/10 gap-[1px] border border-white/10 overflow-hidden">
          <div className="md:col-span-4 bg-background-light p-6 sm:p-10 flex flex-col justify-between group hover:bg-background-elevated transition-colors min-h-[280px]">
            ...
            <div>
              ...
              <p className="text-white/60 text-xs font-normal leading-relaxed">
                Govern organizational security with precise, role-based
                visibility control.
              </p>
            </div>
          </div>
          ...
          <div className="md:col-span-8 bg-background-light p-6 sm:p-10 flex flex-col justify-between group hover:bg-background-elevated transition-colors min-h-[280px] border-t md:border-t-0 md:border-l border-white/10">
            ...
            <div>
              ...
              <p className="text-white/60 text-xs font-normal leading-relaxed max-w-sm">
                Sync GitHub repositories to track PRs, commits, and production
                status in real-time.
              </p>
            </div>
          </div>
          ...
          <div className="md:col-span-8 bg-background-light p-6 sm:p-10 flex flex-col justify-between group hover:bg-background-elevated transition-colors min-h-[280px] border-t border-white/10">
            ...
            <div>
              ...
              <p className="text-white/60 text-xs font-normal leading-relaxed max-w-sm">
                Monitor portfolio velocity and eliminate systemic friction
                points with predictive scoring.
              </p>
            </div>
          </div>
          ...
          <div className="md:col-span-4 bg-background-light p-6 sm:p-10 flex flex-col justify-between group hover:bg-background-elevated transition-colors min-h-[280px] border-t md:border-t-0 md:border-l border-white/10 md:border-t border-white/10">
            ...
            <div>
              ...
              <p className="text-white/60 text-xs font-normal leading-relaxed">
                Orchestrate workspace operations through a natural language
                interface.
              </p>
            </div>
          </div>
          ...
          <div className="md:col-span-6 bg-background-light p-6 sm:p-10 flex flex-col justify-between group hover:bg-background-elevated transition-colors min-h-[280px] border-t border-white/10">
            ...
            <div>
              ...
              <p className="text-white/60 text-xs font-normal leading-relaxed">
                Provision scalable team infrastructure and project workspaces in
                seconds.
              </p>
            </div>
          </div>
          ...
          <div className="md:col-span-6 bg-background-light p-6 sm:p-10 flex flex-col justify-between group hover:bg-background-elevated transition-colors min-h-[280px] border-t md:border-t-1 md:border-l border-white/10">
            ...
            <div>
              ...
              <p className="text-white/60 text-xs font-normal leading-relaxed">
                Visualize cross-team dependencies and optimize technical load
                distribution.
              </p>
            </div>
          </div>
      ...
      <section
        id="verticals"
        className="max-w-[1440px] mx-auto px-6 py-16 md:py-24 border-t border-white/10"
      >
        <div className="mb-12">
          <span className="text-[10px] font-bold uppercase tracking-[0.5em] text-white/60">
            System Features
          </span>
          <h2 className="text-4xl md:text-5xl font-semibold tracking-tighter uppercase mt-4">
          ...
          {[
            {
              role: 'Executive',
              target: 'CTOs & VPs',
              outcome: 'Portfolio Clarity',
            },
            {
              role: 'Delivery',
              target: 'EMs & Leads',
              outcome: 'Velocity Stability',
            },
            {
              role: 'Technical',
              target: 'Architects',
              outcome: 'Enforced Standards',
            },
            {
              role: 'Quality',
              target: 'QA Managers',
              outcome: 'Early Risk Signals',
            },
            ...
            <div
              key={i}
              className="bg-background-light p-6 sm:p-10 hover:bg-background-elevated transition-colors flex flex-col min-h-[200px] md:min-h-[240px]"
            >
              <span className="text-[9px] font-bold uppercase tracking-[0.3em] text-white/40 mb-4">
                {v.role}
              </span>
              <h4 className="text-xl md:text-2xl font-bold uppercase tracking-tight mb-2">
                {v.outcome}
              </h4>
              <p className="text-[10px] font-bold uppercase tracking-widest text-white/30 mt-auto">
                {v.target}
              </p>
            </div>
          ))}
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 bg-white/10 gap-[1px] border border-white/10">
          {[
            ...
            <div
              key={i}
              className={`bg-background-light p-8 sm:p-12 flex flex-col text-left ${p.recommended ? 'relative' : ''}`}
            >
              {p.recommended && (
              ...
              <Link
                to="/register"
                className={`w-full py-4 text-[10px] font-bold uppercase tracking-widest transition-all text-center mb-10 ${
                  p.recommended
                    ? 'bg-white text-black'
      ...
      <footer className="border-t border-white/10 py-12 md:py-20 px-6">
        <div className="max-w-[1440px] mx-auto flex flex-col md:flex-row justify-between items-start md:items-end gap-16 md:gap-24">
          <div className="max-w-md">
            <h2 className="text-4xl md:text-5xl font-bold tracking-tighter uppercase mb-8 md:mb-12">
              NexaSetu
            </h2>
            <p className="text-white/40 text-[10px] md:text-xs font-normal leading-relaxed tracking-wider uppercase">
              Standardizing engineering execution through autonomous
              orchestration. Engineered for institutional reliability.
            </p>
          </div>

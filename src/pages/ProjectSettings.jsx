...
import { Settings, Save, ArrowLeft, Trash2, Archive, Shield, Rocket, Clock } from 'lucide-react';
    ...
    return (
        <div className="max-w-4xl mx-auto px-4 sm:px-8 py-10 space-y-10 animate-in fade-in duration-700">
            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                    <div className="px-3 py-1 bg-primary/10 border border-primary/20 rounded-full">
                        <span className="text-[9px] font-black text-primary uppercase tracking-widest">Project ID: {id.slice(-6)}</span>
                    </div>
                </div>
            </div>
            ...
            <div className="border-b border-white/5 pb-8">
                ...
                <p className="text-text-muted mt-2 font-medium">Fine-tune mission parameters and structural metadata.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                ...
                <div className="space-y-1">
                    {[
                        ...
                        { label: 'Access Control', icon: <Shield size={14} />, to: `/team/project/${id}` },
                ...
                <div className="md:col-span-2 space-y-8">
                    <form onSubmit={handleSave} className="bg-white/[0.02] border border-white/5 p-8 space-y-6">
                        ...
                        <div className="space-y-2">
                            <label className="text-[10px] font-black text-text-muted uppercase tracking-[0.2em] ml-1">Mission Briefing / Description</label>
                            <textarea 
                                rows="4"
                    ...
                    <div className="pt-10 border-t border-white/5">
                        ...
                        <div className="bg-status-error/5 border border-status-error/20 rounded-2xl p-6 flex flex-col sm:flex-row items-center justify-between gap-6">
                            <div className="text-center sm:text-left">
                                <h4 className="text-white font-bold text-sm">Delete this mission</h4>
                                <p className="text-text-muted text-[10px] mt-1">Once deleted, all logs and sub-tasks are cleared from nexus.</p>
                            </div>

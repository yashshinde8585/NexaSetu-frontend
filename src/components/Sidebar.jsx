        ...
        <nav className="flex-1 mt-4 px-0 space-y-1">
          ...
          {navItems.map((item) => (
            <NavLink
              ...
              to={item.path}
              className={({ isActive }) =>
                `relative flex items-center gap-3 px-6 py-3 text-sm font-bold transition-all group ${item.disabled
            ...
            >
              {({ isActive }) => (
                <>
                  ...
                  <span className={`transition-all duration-300 ${!item.disabled && isActive
          ...
          <div className="pt-6">
            ...
            {[
              { 
                name: 'Tasks & Tickets', 
                path: user?.assignedProjectId ? `/project/${user.assignedProjectId._id || user.assignedProjectId}` : '/my-tasks?scope=workspace', 
                icon: <Box size={18} /> 
              },
              ...
              <NavLink
                ...
                onClick={onClose}
                className={({ isActive }) =>
                  `relative flex items-center gap-3 px-6 py-3 text-sm font-bold transition-all group ${isActive

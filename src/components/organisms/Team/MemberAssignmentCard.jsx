    ...
    <div className="p-3 bg-black border border-white/10 rounded-lg flex flex-col gap-3 hover:border-primary/40 transition-all group">
      <div className="flex items-center gap-3">
        ...
        <div className="flex flex-col min-w-0 flex-1">
          <span className="text-[11px] font-black text-white truncate tracking-tight">{member.name}</span>
          <span className="text-[8px] text-primary/50 font-black uppercase truncate tracking-[0.1em]">{member.jobTitle || 'OPERATIVE'}</span>
        </div>
      </div>

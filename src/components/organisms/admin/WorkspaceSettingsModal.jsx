  ...
  const getIcon = () => {
    switch (setting?.key) {
      ...
      case 'notificationRules':
        return <Bell className="text-status-warning" size={24} />;
      default:
        return <SettingsIcon className="text-white/40" size={24} />;
    }
  };
      ...
      <div className="relative w-full max-w-md bg-slate-950 border border-white/10 rounded-3xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200">
        ...
        <div className="px-6 py-5 border-b border-white/5 flex items-center justify-between bg-white/[0.02]">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-white/5 rounded-xl">{getIcon()}</div>
            <div>

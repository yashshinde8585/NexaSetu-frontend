        ...
        {showConfirm && (
          <div className="absolute inset-0 z-[110] bg-slate-950/90 backdrop-blur-md flex flex-col items-center justify-center p-8 text-center animate-in fade-in zoom-in-95">
            ...
            <p className="text-white/40 text-sm mb-8">
              ...
              {user.status === 'Active' &&
                ' This will revoke all workspace access immediately.'}
            </p>
        ...
        <div className="p-8 space-y-8 text-white">
          ...
          <div className="space-y-3">
            ...
            <p className="text-[10px] text-white/20 px-1 italic">
              Permissions update as soon as you save.
            </p>
          </div>

          {/* Quick Actions */}
          <div className="pt-4 border-t border-white/5">
            <label className="text-[10px] uppercase tracking-widest text-white/30 font-bold px-1 mb-3 block">
              Danger Zone
            </label>
            <button

...
// Profile management identity section.
    ...
    <DeckWrapper title="USER_PROFILE">
      <div className="flex flex-col sm:flex-row items-center gap-6 p-4 bg-black border border-white/10 rounded">
        ...
        <div className="flex-1 space-y-1 text-center sm:text-left min-w-0">
          <div className="text-[8px] font-black text-white/40 uppercase tracking-[0.2em]">
            ACTIVE_USER
          </div>
          <h3 className="text-[14px] font-black text-white uppercase tracking-widest truncate">
            {user.name}
          </h3>
          <p className="text-[9px] text-white/60 font-black uppercase tracking-widest truncate">
            {user.email}
          </p>
        </div>
      </div>
  ...
  <DeckWrapper title="ACCOUNT_SECURITY">
    <div className="grid grid-cols-1 gap-2">
      ...
      <SecurityRow
        ...
        desc="MANAGE SESSION VISIBILITY."
      />
    </div>
  </DeckWrapper>
);
  ...
  <div className="p-3 bg-black border border-white/10 hover:border-white/20 rounded flex items-center justify-between group cursor-pointer transition-all">
    <div className="flex items-center gap-3">
      ...
      <div className="min-w-0">
        ...
        <p className="text-[8px] font-black text-white/40 uppercase tracking-[0.2em] truncate">
          {desc}
        </p>
      </div>
    </div>
  ...
  <DeckWrapper title="PLATFORM_PREFERENCES">
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <div className="space-y-1">
        ...
        <TacticalSelect
          icon={<Bell size={14} />}
          options={['ALL NOTIFICATIONS', 'CRITICAL ONLY', 'MUTED']}

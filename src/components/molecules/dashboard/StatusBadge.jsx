...
const StatusBadge = ({ status }) => {
  const configs = {
    ...
    'in_progress': 'bg-sky-500/10 text-sky-400 border-sky-500/20 shadow-[0_0_10px_rgba(14,165,233,0.1)]',
  ...
  return (
    <span className={`px-2.5 py-1 rounded-full text-[9px] font-black uppercase tracking-widest border ${configs[status] || configs.todo}`}>
      {getLabel()}
    </span>
  );
};
